...
namespace IdleMaster
{
    public partial class frmBrowser : Form
    {
        ...
        private void wbAuth_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            {
                Type dynamicType = globalHeader.GetType();
                if (dynamicType.GetProperties().Any(x => x.Name.Equals("parentNode"))) // Make sure this parentNode actually exists instead of crashing IM.
