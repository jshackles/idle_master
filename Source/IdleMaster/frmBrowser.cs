...
namespace IdleMaster
{
    public partial class frmBrowser : Form
    {
        ...
        private int _secondsWaiting = 30;
                ...
                url.StartsWith("about:") == false)
            {
                ...
                foreach (Cookie cookie in cookies)
                {
                    ...
                    else if (cookie.Name == "steamLogin")
                    {
                        ...
                        Settings.Default.myProfileURL = "http://steamcommunity.com/profiles/" +
                                                        cookie.Value.Substring(0, 17);
                    }
        ...
        private void tmrCheck_Tick(object sender, EventArgs e)
        {
            ...
            if (_secondsWaiting > 0)
            {
                _secondsWaiting = _secondsWaiting - 1;
            }
            else
            {
